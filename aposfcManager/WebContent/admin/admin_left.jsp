  ...
  <tr>
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content">
        ...
        <li><a href="${pageContext.request.contextPath}/menusServlet?action=findtypesAll" target="main">添加新菜单</a></li>
      ...
      <div class="content">
        ...
        <ul class="MM">
		   <li><a href="admin/notice_add.jsp" target="main">添加新通告</a></li>
            <li><a href="${pageContext.request.contextPath}/noticesServlet?action=findAll" target="main">通告信息列表</a></li>
        </ul>
      </div>
