						...
						<table id="table2" class="line_table"
							...
							<tr>
								...
								<td class="line_table" height="25" width="70%">
									<input type="hidden" name="id" value="${requestScope.menu.id}"/>
								<input type="text" name="name" size="45" value="${requestScope.menu.name}"></td>
								...
								<td class="line_table" height="25" width="80%"><select
									name="typeid">
										<c:forEach items="${requestScope.types }" var="type">
											<c:choose>
												<c:when test="${type.id eq menu.typeid }">
