	...
	<table width="100%" height="1" border="0" cellpadding="0"
		...
		<tr>
			<td valign="top" bgcolor="#F7F8F9">
				...
				<div align="center">
					<form action="${pageContext.request.contextPath }/typesServlet?action=findTypesById&&id=${type.id}" method="post"
						...
						<table id="table2" class="line_table"
							...
							<tr>
								...
								<td class="line_table" height="25" width="60%"><input
									...
									<input type="hidden" name="id" value="${request.types.id }" /></td>
							</tr>
